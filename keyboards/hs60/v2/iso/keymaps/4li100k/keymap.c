...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_fn] = LAYOUT_60_iso( /* FN */
        ...
        KC_TRNS,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_END,   KC_MUTE,  KC_VOLD,  XXXXXXX,\
    ...
    [_pn] = LAYOUT_60_iso( /* PN */
        ...
        XXXXXXX,  S1_DEC,   S1_INC,   S2_DEC,   S2_INC,   ES_DEC,   ES_INC,  KC_MS_BTN1,KC_MS_UP,KC_MS_BTN2,XXXXXXX,  XXXXXXX,  BR_INC,           \
        XXXXXXX,  EF_DEC,   EF_INC,   H1_DEC,   H1_INC,   H2_DEC,   H2_INC,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,XXXXXXX, XXXXXXX,  BR_DEC,   XXXXXXX,\
